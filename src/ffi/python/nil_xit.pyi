...
class FileInfo:
	group: str
	path: str
	def __init__(self, group: str, path: str) -> None: ...
...
class Core:
	...
	def add_unique_frame(self, id: str, info: Optional[FileInfo] = ...) -> UniqueFrame: ...
	def add_tagged_frame(self, id: str, info: Optional[FileInfo] = ...) -> TaggedFrame: ...
