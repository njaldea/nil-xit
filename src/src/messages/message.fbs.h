...
enum MessageType : int32_t {
  ...
  MessageType_Client_Unique_FrameCache = 8,
  MessageType_Client_Tagged_FrameCache = 9,
  MessageType_Client_Unique_Frame_Loaded = 10,
  MessageType_Client_Tagged_Frame_Loaded = 11,
  MessageType_Client_Unique_Frame_Subscribe = 12,
  MessageType_Client_Tagged_Frame_Subscribe = 13,
  MessageType_Client_Unique_Frame_Unsubscribe = 14,
  MessageType_Client_Tagged_Frame_Unsubscribe = 15,
  MessageType_Client_Unique_Value_Request = 16,
  MessageType_Client_Tagged_Value_Request = 17,
  MessageType_Server_Unique_Value_Response = 18,
  MessageType_Server_Tagged_Value_Response = 19,
  MessageType_Unique_Value_Update = 20,
  MessageType_Tagged_Value_Update = 21,
  MessageType_Client_Unique_Signal_Request = 22,
  MessageType_Client_Tagged_Signal_Request = 23,
  MessageType_Server_Unique_Signal_Response = 24,
  MessageType_Server_Tagged_Signal_Response = 25,
  MessageType_Client_Unique_Signal_Notify = 26,
  MessageType_Client_Tagged_Signal_Notify = 27,
