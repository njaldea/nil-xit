...
namespace nil::xit
{
    ...
    template <typename T>
    void internal_set(Binding<T>& binding, const T& value)
    {
    ...
    core_ptr_t make_core(nil::service::IService& service)
    {
        ...
        auto ret = core_ptr_t{new Core(&service, {}), deleter};
